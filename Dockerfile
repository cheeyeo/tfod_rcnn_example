...
RUN mkdir -p experiments/evaluation experiments/exported_model experiments/training && \
...
ENTRYPOINT ["/bin/bash", "train.sh", "models", "experiments/training", "experiments/exported_model", "faster_rcnn_lisa_docker.config"]